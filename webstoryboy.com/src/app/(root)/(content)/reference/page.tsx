          ...
          <TabsContent value='tab-1'>
            <div className='page__title'>
              ...
              <p>
                ...
                구성했습니다. 처음 HTML을 배우는 입문자의 관점에서 시작해, 실무에 필요한 구조 설계와
                문서 작성 방식까지 연결하는 실전 중심 강의입니다.
              </p>
          ...
          <TabsContent value='tab-2'>
            <div className='page__title'>
              ...
              <ul>
                ...
                <li>Tailwind나 Sass 같은 도구 사용 전에 CSS 기본기를 탄탄히 다지고 싶은 개발자</li>
              </ul>
              ...
              <p>
                ...
                콘텐츠를 설계했습니다. 단순한 속성 나열이 아닌, 구조 중심의 사고방식과 실전 UI 구현
                능력을 키울 수 있도록 실습 위주로 구성되어 있습니다.
              </p>

              <h3 className='mt-6'>지금 시작하세요</h3>
              <p>
                CSS를 제대로 이해하면, 어떤 프레임워크든 쉽게 다룰 수 있습니다. 웹 디자인의 기본기를
                정립하고, 구조적이고 아름다운 웹을 만들 준비가 되었다면 지금 이 강의로 시작해보세요.
              </p>
          ...
          <TabsContent value='tab-3'>
            <div className='page__title'>
              ...
              <p>
                ...
                처리, DOM 제어까지 전반적인 흐름을 단계별로 익힐 수 있도록 구성되어 있습니다. 단순히
                따라 쓰는 예제가 아니라, 직접 문제를 해결하고 구조를 설계할 수 있는 사고력을 키우는
                데 초점을 맞췄습니다.
              </p>
              ...
              <ul>
                ...
                <li>이벤트 처리, 조건문, 반복문, 함수 등 프로그래밍 기본 개념을 체계적으로 학습</li>
              ...
              <h3 className='mt-6'>강사 소개</h3>
              <p>
                JavaScript로 수많은 인터랙티브 웹사이트를 제작한 경험을 가진 강사가 직접 커리큘럼을
                구성했습니다. 단순한 문법 강의가 아닌, 사용자의 흐름을 고려한 기능 설계 방식과 코드
                작성 습관까지 함께 배울 수 있는 실전형 강의입니다.
              </p>
