      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <Button
            variant='ghost'
            size='icon'
            className={`group h-11 w-11 border border-orange-600 rounded-full ${
              session?.user
                ...
                <>
                  ...
                  {session.user.username && (
                    <Link
                      ...
                      className='inline-block mt-2 px-3 py-1 bg-orange-600 text-white text-xs rounded-full hover:bg-orange-700 transition-colors'
