...
export default function AdminContacts() {
  ...
  const [deletedContact, setDeletedContact] = useState<IContact | null>(null)
  ...
  // 삭제 성공 완료 처리(부분로딩)
  const handleDeleteSuccess = (deletedContact: IContact) => {
    // 목록에서 삭제된 문의사항 제거
    setContacts((prevContacts) =>
      prevContacts.filter((contact) => contact._id !== deletedContact._id)
    )
