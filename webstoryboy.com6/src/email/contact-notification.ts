...
export async function sendContactNotification(contactInfo: {
  ...
  try {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); padding: 30px; border-radius: 10px; text-align: center; margin-bottom: 30px;">
            ...
            <p style="color: #f0f0f0; margin: 10px 0 0 0; font-size: 16px;">새로운 문의가 접수되었습니다</p>
          </div>
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid #e9ecef; color: #6c757d;">
                  <a href="mailto:${
                    contactInfo.email
                  }" style="color: #007bff; text-decoration: none;">${contactInfo.email}</a>
                </td>
              </tr>
              <tr>
          ...
          <div style="background: #e3f2fd; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            <h3 style="color: #1565c0; margin-top: 0; font-size: 18px;">📋 문의 제목</h3>
          ...
          <div style="background: #fff3cd; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            <h3 style="color: #856404; margin-top: 0; font-size: 18px;">💬 문의 내용</h3>
          ...
          <div style="text-align: center; margin-top: 30px;">
            <a href="mailto:${contactInfo.email}?subject=Re: ${contactInfo.title}" 
    ...
    console.log(`문의자: ${contactInfo.email} | 제목: ${contactInfo.title}`)
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8f9fa; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #28a745;">
              ...
              <p style="margin: 5px 0;"><strong>제목:</strong> ${contactInfo.title}</p>
