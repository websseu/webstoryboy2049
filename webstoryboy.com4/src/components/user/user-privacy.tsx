...
export default function UserPrivacy() {
  return (
    <Sheet>
      <SheetTrigger className='uline'>개인정보취급방침</SheetTrigger>
        ...
        <ScrollArea className='w-full h-[calc(100vh-90px)] pr-2'>
          <div className='user__title'>
            ...
            <p className='mb-4 mt-4'>
              웹스토리보이(이하 &quot;회사&quot;)는 개인정보 보호를 매우 중요하게 생각하며,
              『개인정보 보호법』 등 관련 법령을 준수하고 있습니다. 본 방침은 회사가 제공하는
              서비스에 적용되며, 회사가 어떤 정보를 수집하고, 어떻게 사용하며, 어떠한 방식으로
              보호하는지를 설명합니다.
            </p>
            ...
            <p>
              회원의 개인정보는 수집 및 이용 목적이 달성된 후에는 지체 없이 파기됩니다. 단, 다음의
              정보는 관련 법령에 따라 일정 기간 동안 보존됩니다:
            </p>
            <ul>
            ...
            <p>
              회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않으며, 다음의 경우에만 예외로
              제공합니다:
            </p>
            <ul>
              <li>이용자가 사전에 동의한 경우</li>
              <li>법령의 규정에 의거하거나, 수사 목적으로 정해진 절차에 따라 요청이 있는 경우</li>
            </ul>

            <h3>제5조 (개인정보 보호책임자)</h3>
            <p>
              회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 관련 문의사항에
              성실하게 답변하겠습니다.
            </p>
            <ul>
              <li>성명: 황상연</li>
            ...
            <p>
              회사는 개인정보 보유기간의 경과 또는 처리목적 달성 후에는 해당 정보를 지체 없이
              파기합니다.
            </p>
            ...
            <p className='mt-12 text-zinc-500'>※ 본 방침은 2025년 5월 2일부터 적용됩니다.</p>
          </div>
        </ScrollArea>
      </SheetContent>
    </Sheet>
