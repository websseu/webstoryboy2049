  ...
  return (
    <li>
      <NavigationMenuLink asChild>
        <Link
          href={href}
          className='font-nanum block select-none space-y-1 rounded-sm p-3 leading-none no-underline outline-red-500 transition hover:bg-accent hover:text-accent-foreground'
        >
