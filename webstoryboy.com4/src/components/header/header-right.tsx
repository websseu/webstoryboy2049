...
import { BadgeCheck, SmilePlus, FolderLock, NotebookPen, Bell } from 'lucide-react'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  return (
    <div className='absolute right-4'>
      <DropdownMenu>
        ...
        <DropdownMenuContent className='w-56 mr-0 mt-1 bg-background' align='end' forceMount>
          {session ? (
            <>
              <DropdownMenuLabel className='font-normal'>
                <div className='flex items-center'>
                  ...
                  <div className='flex flex-col space-y-1'>
                    ...
                    <p className='text-[10px] leading-none text-black700'>{session.user?.email}</p>
                  </div>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <Link href={'/notice'} className='w-full flex gap-2 items-center cursor-pointer'>
                  <BadgeCheck className='h-4 w-4' />
                  공지사항
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link href={'/contact'} className='w-full flex gap-2 items-center cursor-pointer'>
                ...
                <>
                  ...
                  <DropdownMenuSub>
                    ...
                    <DropdownMenuPortal>
                      <DropdownMenuSubContent>
                        <DropdownMenuItem asChild>
                          <Link href='/admin/contact' className='cursor-pointer'>
                            문의사항 관리
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
            ...
            <>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <Link href={'/sign-up'} className='w-full flex gap-2 items-center cursor-pointer'>
