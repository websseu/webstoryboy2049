...
import { Beer, ChevronRight, Coffee, Rabbit, Salad } from 'lucide-react'
...
export default function HeaderRight({ session }: HeaderRightProps) {
  ...
  return (
    <>
              ...
              {session?.user ? (
                ...
                <>
                  ...
                  <div className='flex items-center justify-center gap-1'>
                    ...
                    <span className='font-nanum text-xs text-blue-600'>스타벅스 정보</span>
                    <div className='w-2 h-2 bg-green-200 rounded-full ml-2'></div>
                    <span className='font-nanum text-xs text-green-600'>커뮤니티</span>
                    <div className='w-2 h-2 bg-purple-200 rounded-full ml-2'></div>
                    <span className='font-nanum text-xs text-purple-600'>기록 관리</span>
                  </div>
                </>
              )}
            </div>
      ...
      <DialogFindEmail open={isFindEmailOpen} onOpenChange={setIsFindEmailOpen} />
