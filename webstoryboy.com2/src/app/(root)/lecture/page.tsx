        ...
        <Tabs defaultValue='tab-1'>
          ...
          <TabsContent value='tab-2'>
            <div className='page__title'>
              <h2>스크립트를 잘 이해하려면?</h2>
              <p>
                자바스크립트(JavaScript)와 타입스크립트(TypeScript)는 현대 웹 개발에서 중요한 역할을
                하는 언어입니다. 본 강의는 두 언어의 차이를 명확하게 이해하고, 상황에 맞게 적절히
                활용할 수 있도록 구성되었습니다. 자바스크립트의 유연함과 타입스크립트의 안정성을
                실무 프로젝트 중심으로 비교하며 실제 적용 방법을 배웁니다.
              </p>

              <h3 className='mt-6'>이 강의는 이런 분들을 위해 준비했습니다</h3>
              <ul>
                <li>자바스크립트로 기본기를 다졌지만 타입스크립트 전환이 어려운 개발자</li>
                <li>JS와 TS의 차이를 실무 예제로 익히고 싶은 웹 개발자</li>
                <li>유지보수성과 안정성이 중요한 팀 프로젝트를 준비 중인 분</li>
                <li>타입 시스템을 도입해 코드의 오류 가능성을 줄이고 싶은 실무자</li>
              </ul>

              <h3 className='mt-6'>강의 특징</h3>
              <ul>
                <li>자바스크립트와 타입스크립트의 핵심 개념을 나란히 비교하여 빠르게 이해</li>
                <li>동적 타입과 정적 타입의 특성을 실전 시나리오를 통해 설명</li>
                <li>기존 자바스크립트 코드를 타입스크립트로 변환하는 마이그레이션 실습</li>
                <li>
                  타입 추론, 유니온 타입, 인터섹션 타입, 제네릭 등 실무에서 자주 쓰는 개념 학습
                </li>
                <li>코드 자동완성, 리팩토링 등 타입스크립트의 생산성 향상 효과를 직접 체험</li>
                <li>실제 프로젝트 기반으로 JS와 TS의 차이를 비교하고 적용</li>
              </ul>

              <h3 className='mt-6'>강사 소개</h3>
              <p>
                다수의 프론트엔드 프로젝트와 협업 경험을 가진 강사가 직접 커리큘럼을 설계했습니다.
                자바스크립트의 유연함을 기반으로 타입스크립트를 자연스럽게 익힐 수 있도록 구성되어
                있으며, 코드 품질과 협업 효율을 함께 높일 수 있는 실용적인 노하우를 공유합니다.
              </p>

              <h3 className='mt-6'>지금 시작하세요</h3>
              <p>
                동적인 개발의 자유로움과 정적인 타입 안정성을 모두 갖춘 개발자가 되고 싶다면, 이
                강의를 통해 현대 프론트엔드 개발의 기준을 나만의 것으로 만들어보세요.
              </p>
