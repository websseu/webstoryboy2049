...
const nanumSquare = localFont({
  ...
  src: [
    ...
    { path: './fonts/NanumSquareNeo-Black.woff2', weight: '900', style: 'normal' },
  ],
})
...
const nanumHuman = localFont({
  ...
  display: 'swap',
  src: [
    { path: './fonts/NanumHuman-ExtraLight.woff', weight: '200', style: 'normal' },
    { path: './fonts/NanumHuman-Light.woff', weight: '300', style: 'normal' },
    { path: './fonts/NanumHuman-Regular.woff', weight: '400', style: 'normal' },
    { path: './fonts/NanumHuman-Bold.woff', weight: '700', style: 'normal' },
    { path: './fonts/NanumHuman-ExtraBold.woff', weight: '800', style: 'normal' },
  ],
})
...
const gmarketSans = localFont({
  ...
  display: 'swap',
  src: [
    { path: './fonts/GmarketSans-Light.woff2', weight: '300', style: 'normal' },
    { path: './fonts/GmarketSans-Medium.woff2', weight: '500', style: 'normal' },
    { path: './fonts/GmarketSans-Bold.woff2', weight: '700', style: 'normal' },
  ],
})
