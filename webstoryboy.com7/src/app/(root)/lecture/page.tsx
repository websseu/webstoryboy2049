  ...
  return (
    <section>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
        <div className='page__title border rounded'>
          <h2>
            <Crown />
            웹디자인개발기능사
          </h2>
          <p>
            ...
            시험으로, 실무 중심의 웹 디자인 역량을 검증하는 중요한 자격입니다.
          </p>
          <p>
          ...
          <p>
            ...
            기획하고 진행합니다. 다양한 프로젝트 수행과 교육 경험을 바탕으로, 시험에 꼭 나오는 핵심
            개념과 실무에서 바로 적용할 수 있는 노하우를 집약하였습니다. 수많은 수강생들의 합격과
            실력 향상을 이끌어온 신뢰도 높은 강의입니다.
          </p>

          <h3>지금 시작하세요</h3>
          <p>
            단순한 자격증 취득을 넘어 실무에 활용 가능한 역량 강화까지. 웹디자인기능사 2025의 합격은
            물론, 자신만의 웹 포트폴리오까지 함께 완성해보세요. 지금 바로 시작하면, 더 빠르게 성장할
            수 있습니다!
          </p>

          <Link href='/lecture/web-design-2025'>
            <TvMinimalPlay />
            시작하기
          </Link>
        </div>
        ...
        <div className='page__title border rounded'>
          ...
          <p>
            ...
            이미지를 전달하고, 방문자의 행동을 유도하는 중요한 수단이 됩니다.{' '}
          </p>
          <p>
            본 강의는 애니메이션 라이브러리인 <strong>GSAP(GreenSock Animation Platform)</strong>을
          ...
          <ul>
            ...
            <li>
              포트폴리오와 실무 프로젝트에 인터랙티브 요소를 더하고 싶은 디자이너·프론트엔드 개발자
            </li>
          </ul>
          ...
          <p>
            ...
            원리를 쉽게 이해할 수 있도록 시각적인 예제 중심으로 설명하며, 실무에서 활용할 수 있는
            코드 패턴과 성능 최적화 팁까지 함께 전달합니다.
          </p>

          <h3>지금 시작하세요</h3>
          <p>
            웹사이트의 완성도를 한 단계 끌어올리고 싶다면, GSAP 강의를 통해 실감나는 애니메이션과
            인터랙션을 익혀보세요. 여러분의 웹페이지는 이제 단순한 정보 공간이 아니라, 경험을
            전달하는 공간이 될 수 있습니다.
          </p>
          <Link href='/lecture/gsap-parallax-effect'>
            <TvMinimalPlay />
            시작하기
          </Link>
        </div>
