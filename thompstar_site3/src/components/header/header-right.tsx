      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <Button
            variant='ghost'
            size='icon'
            className='group h-11 w-11 border border-orange-600 bg-orange-600 hover:bg-white hover:border-orange-600 rounded-full hover:text-white'
          >
            <TentTree className='text-white group-hover:text-orange-600' />
            <span className='sr-only'>메뉴 열기</span>
          </Button>
        </SheetTrigger>
        <SheetContent side='right' className='w-80 gap-0'>
          <SheetHeader className='border-b'>
            <SheetTitle className='font-gmarket text-xl font-bold text-orange-600 mt-1 pb-4'>
              {APP_NAME}
            </SheetTitle>
            ...
            <div className='text-center py-2'>
              {session?.user ? (
                <>
                  ...
                  <p className='font-nanum text-xs text-orange-600 mt-1'>
                ...
                <>
                  <div className='flex justify-center mb-3'>
                    <div className='w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center'>
                      <Salad className='w-6 h-6 text-orange-600' />
                    </div>
                  </div>
                  <h3 className='font-gmarket font-bold text-lg text-gray-900'>
                    방가워요! 환영합니다!
                ...
                {menuItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className='w-full flex items-center justify-between px-4 py-3 text-left hover:bg-orange-50 transition-colors group cursor-pointer'
                    >
                      <div className='flex items-center gap-3'>
                        <Icon className='w-4 h-4 text-gray-600 group-hover:text-orange-600' />
                        <span className='font-nanum text-sm text-gray-900 group-hover:text-orange-600'>
                          {item.label}
                        </span>
                      </div>
            ...
            {!session?.user && (
              <div className='py-2 border-b'>
                <nav className='space-y-1'>
                  ...
                  >
                    <div className='flex items-center gap-3'>
                      <Mail className='w-4 h-4 text-gray-600 group-hover:text-orange-600' />
                      <span className='font-nanum text-sm text-gray-900 group-hover:text-orange-600'>
                        이메일 찾기
                      </span>
                    </div>
                  ...
                  >
                    <div className='flex items-center gap-3'>
                      <Lock className='w-4 h-4 text-gray-600 group-hover:text-orange-600' />
                      <span className='font-nanum text-sm text-gray-900 group-hover:text-orange-600'>
                        비밀번호 찾기
                      </span>
                    </div>
            ...
            {showAdminItems && (
              <div className='border-b py-2'>
                <nav className='space-y-1'>
                  ...
                  >
                    <div className='flex items-center gap-3'>
                      <Beer className='w-4 h-4 text-gray-600 group-hover:text-orange-600' />
                      <span className='font-nanum text-sm text-gray-900 group-hover:text-orange-600'>
                        관리자 페이지
                      </span>
                    </div>
