...
import { Mail, Shield, CheckCircle, Barrel, Calendar, Eye, Send, Panda, Crown } from 'lucide-react'
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function DialogUserDetail({ open, onOpenChange, user }: DialogUserDetailProps) {
  if (!user) return null
        ...
        <div className='space-y-2 text-sm max-h-[60vh] overflow-y-auto'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <div className='min-w-0 flex-1'>
              ...
              <span className='ml-2 text-gray-900 break-words'>{user.name}</span>
            </div>
          </div>
          ...
          {/* 사용자 이름 */}
          <div className='flex items-center gap-2'>
            <Barrel className='h-4 w-4 text-yellow-600 flex-shrink-0' />
            <div className='min-w-0 flex-1'>
              <span className='font-medium text-gray-700'>사용자 이름:</span>
              <span className='ml-2 text-gray-900 break-words'>@{user.username}</span>
            </div>
          </div>
          ...
          <div className='flex items-center gap-2'>
            ...
            <div className='min-w-0 flex-1'>
              ...
              <span className='ml-2 text-gray-900 break-words'>{user.email}</span>
            </div>
          </div>
            ...
            <div className='min-w-0 flex-1'>
              ...
              <span className='ml-2'>
                <Badge
                  className={
                    user.isActive
                      ? 'text-green-600 bg-transparent border-green-600'
                      : 'text-gray-500 bg-transparent border-gray-500'
                  }
                >
          ...
          <div className='flex items-center gap-2'>
            <CheckCircle className='h-4 w-4 text-green-600 flex-shrink-0' />
            <div className='min-w-0 flex-1'>
              <span className='font-medium text-gray-700'>가입 경로:</span>
