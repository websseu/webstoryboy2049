...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot='tabs-list'
      className={cn(
        'font-nanum bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded p-[3px]',
        className
      )}
      {...props}
    />
